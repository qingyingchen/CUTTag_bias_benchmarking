...
K562_RNA_filtered_log <-transform(K562_RNA_filtered,FPKM_RNA1_rep1=log2(FPKM_RNA1_rep1+1),
...
K562_RNA_filtered_log$FPKM_RNA1_rep1 <- scale(K562_RNA_filtered_log$FPKM_RNA1_rep1)
K562_RNA_filtered_log$FPKM_RNA1_rep2 <- scale(K562_RNA_filtered_log$FPKM_RNA1_rep2)
K562_RNA_filtered_log$FPKM_RNA2_rep1 <- scale(K562_RNA_filtered_log$FPKM_RNA2_rep1)
K562_RNA_filtered_log$FPKM_RNA2_rep2 <- scale(K562_RNA_filtered_log$FPKM_RNA2_rep2)
K562_RNA_filtered_log$FPKM_RNA2_rep3 <- scale(K562_RNA_filtered_log$FPKM_RNA2_rep3)
K562_RNA_filtered_log$average <- apply(K562_RNA_filtered_log[,9:13], 1, mean)
K562_RNA_filtered_log_sort<-K562_RNA_filtered_log[order(K562_RNA_filtered_log$average,decreasing=T),]
K562_RNA_5K<- K562_RNA_filtered_log_sort[1:5000,c(3,5,6,1,7,4,9,10,11,12,13,14)]
...
K562_RNA_8K<- K562_RNA_filtered_log_sort[1:8032,c(3,5,6,1,7,4,9,10,11,12,13,14)]
...
write.table(K562_RNA_8K,file = "/Users/jkx9nz/Dropbox/CUTTagResults/result/TSS_bias/RNA/K562_RNA_8K.bed",
            row.names=F,col.names=F,sep="\t",quote=F)
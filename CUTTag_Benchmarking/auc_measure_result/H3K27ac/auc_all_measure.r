...
method <- c("macs2broad","macs2broadATAC","macs2broadIgG","SEACRstr","SEACRstrATAC","SEACRstrIgG","SEACRrel","SEACRrelATAC","SEACRrelIgG","MUSIC","MUSICATAC","MUSICIgG","GoPeaks","GoPeaksATAC","GoPeaksIgG","RSEG","RSEGATAC","RSEGIgG","RSEGdz","RSEGdzATAC","RSEGdzIgG")
...
cutoffs<- cbind(a1,a1,a1,d1,f,f,ccc1,f,f,cc1,cc1,cc1,cc1,cc1,cc1,b1,b1,b1,b1,b1,b1)
...
write.table(score_ROC,file=paste0(path2,"auROCscore_ac.txt"),row.names=T,col.names=T,sep="\t",quote=F)
write.table(score_PRC,file=paste0(path2,"auPRCscore_ac.txt"),row.names=T,col.names=T,sep="\t",quote=F)
write.table(final_score_mean,file=paste0(path2,"AUCmeanscore_ac.txt"),row.names=T,col.names=T,sep="\t",quote=F)
write.table(final_ROC,file=paste0(path2,"auROCrank_ac.txt"),row.names=T,col.names=T,sep="\t",quote=F)
write.table(final_PRC,file=paste0(path2,"auPRCrank_ac.txt"),row.names=T,col.names=T,sep="\t",quote=F)
write.table(final_mean,file=paste0(path2,"AUCmeanrank_ac.txt"),row.names=T,col.names=T,sep="\t",quote=F)

...
CUTTags = c("GSM3536514","GSM4797825","GSM4797826")
...
write.table(score_ROC,file=paste0(path2,"auROCscore_ctrl_ATAC_ac.txt"),row.names=T,col.names=T,sep="\t",quote=F)
write.table(score_PRC,file=paste0(path2,"auPRCscore_ctrl_ATAC_ac.txt"),row.names=T,col.names=T,sep="\t",quote=F)
write.table(final_ROC,file=paste0(path2,"auROCrank_ctrl_ATAC_ac.txt"),row.names=T,col.names=T,sep="\t",quote=F)
write.table(final_PRC,file=paste0(path2,"auPRCrank_ctrl_ATAC_ac.txt"),row.names=T,col.names=T,sep="\t",quote=F)
write.table(final_mean,file=paste0(path2,"AUCmeanrank_ctrl_ATAC_ac.txt"),row.names=T,col.names=T,sep="\t",quote=F)

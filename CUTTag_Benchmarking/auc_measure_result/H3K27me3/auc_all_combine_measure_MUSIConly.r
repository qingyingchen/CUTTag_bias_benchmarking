...
method <- c("MUSIC","MUSICATAC","MUSICIgG")
...
write.table(score_ROC,file=paste0(path2,"auROCscore_MUSIConly.txt"),row.names=T,col.names=T,sep="\t",quote=F)
write.table(score_PRC,file=paste0(path2,"auPRCscore_MUSIConly.txt"),row.names=T,col.names=T,sep="\t",quote=F)
write.table(final_ROC,file=paste0(path2,"auROCrank_MUSIConly.txt"),row.names=T,col.names=T,sep="\t",quote=F)
write.table(final_PRC,file=paste0(path2,"auPRCrank_MUSIConly.txt"),row.names=T,col.names=T,sep="\t",quote=F)
write.table(final_mean,file=paste0(path2,"AUCmeanrank_MUSIConly.txt"),row.names=T,col.names=T,sep="\t",quote=F)

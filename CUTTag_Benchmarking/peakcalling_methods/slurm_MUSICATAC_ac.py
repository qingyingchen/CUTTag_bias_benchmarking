...
for CUTTagid in CUTTags:
    for cutoff in cutoffs:
        ...
        outname = "%s_MUSICATAC_cut%s"%(CUTTagid,cutoff)
        model="""#!/bin/bash
...
mkdir %s
cd %s
MUSIC -get_multiscale_broad_ERs -chip /project/zanglab_project/jkx9nz/project/cut/FACTOR/HUMAN/combineReads/MUSIC/%s_K562_WT_CUTTag_H3K27ac/dedup -control /project/zanglab_project/jkx9nz/project/cut/FACTOR/HUMAN/combineReads/MUSIC/K562_ATAC2/dedup -mapp Mappability_36bp -l_mapp 36 -begin_l 1000 -end_l 16000 -step 1.5 -q_val %s

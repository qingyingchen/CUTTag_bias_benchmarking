...
for CUTTagid in CUTTags:
    for cutoff in cutoffs:
        ...
        outname = "%s_GoPeaks_cut%s"%(CUTTagid,cutoff)
        model="""#!/bin/bash
...
gopeaks -b /project/zanglab_project/jkx9nz/project/cut/FACTOR/HUMAN/bam/acme3/%s_K562_WT_CUTTag_H3K27ac.bam -o %s --broad -p %s

...
for CUTTagid in CUTTags:
    for cutoff in cutoffs:
        ...
        outname = "%s_RSEGdzIgG_cut%s"%(CUTTagid,cutoff)
        model="""#!/bin/bash
...
rseg-diff -c /project/zanglab_project/jkx9nz/data/human-hg18-size.bed -o %s.bed -i 20 -d /project/zanglab_project/jkx9nz/data/deadzones-k32-hg18.bed -v -mode 2 /project/zanglab_project/jkx9nz/project/cut/FACTOR/HUMAN/combineReads/PEuniq/acme3/%s_K562_WT_CUTTag_H3K27ac_PEuniq.bed /project/zanglab_project/jkx9nz/data/IgG/K562_IgG1_PEuniq_sorted.bed -cutoff %s

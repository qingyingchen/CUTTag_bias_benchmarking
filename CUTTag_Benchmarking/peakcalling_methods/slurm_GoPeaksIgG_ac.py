...
for CUTTagid in CUTTags:
    for cutoff in cutoffs:
        ...
        outname = "%s_GoPeaksIgG_cut%s"%(CUTTagid,cutoff)
        model="""#!/bin/bash
...
gopeaks -b /project/zanglab_project/jkx9nz/project/cut/FACTOR/HUMAN/bam/acme3/%s_K562_WT_CUTTag_H3K27ac.bam -c /project/zanglab_project/jkx9nz/project/cut/FACTOR/HUMAN/bam/acme3/K562_IgG1.bam -o %s --broad -p %s

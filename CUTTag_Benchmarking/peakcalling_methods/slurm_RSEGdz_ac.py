...
for CUTTagid in CUTTags:
    for cutoff in cutoffs:
        ...
        outname = "%s_RSEGdz_cut%s"%(CUTTagid,cutoff)
        model="""#!/bin/bash
...
rseg -c /project/zanglab_project/jkx9nz/data/human-hg18-size.bed -o %s.bed -i 20 -d ../deadzones-k32-hg18.bed -v /project/zanglab_project/jkx9nz/project/cut/FACTOR/HUMAN/combineReads/PEuniq/acme3/%s_K562_WT_CUTTag_H3K27ac_PEuniq.bed -cutoff %s

...
pdf("/Users/jkx9nz/Library/CloudStorage/Dropbox/CUTTagResults/result/benchmarking/cutoff_all_sicer/figures_17me3/AUC_SEACRrel_performance_diff1.pdf", w = 9 ,h=4.5)
par(mfcol=c(1,4))
palette2 <- brewer.pal(n = 9, name = "Purples")
palette<- c(palette2[7],palette2[6])

plot(0, type="n",main="SEACRrel FPR", xlim=c(0.5,2.5), ylim=c(-1,1), yaxt="n", xaxt="n", xlab="", ylab="",cex.axis=2)#, ylab="auFPR_comp_rank")
box(lwd = 2)
...
plot(0, type="n",main="SEACRrel TNR", xlim=c(0.5,2.5), ylim=c(-1,1), yaxt="n", xaxt="n", xlab="", ylab="",cex.axis=2)#, ylab="auFPR_comp_rank")
box(lwd = 2)
abline(h = 0, col = palette2[9],lty = 2.5, lwd=1.5)
axis(2, at=seq(-1,1,0.5), las=1, tck=-0.08,cex.axis=1,col.axis="white",lwd=2)
box_pos <- c(1:2)
...
plot(0, type="n",main="SEACRrel TPR", xlim=c(0.5,2.5), ylim=c(-1,1), yaxt="n", xaxt="n", xlab="", ylab="",cex.axis=2)#, ylab="auTPR_comp_rank")
box(lwd = 2)
abline(h = 0, col = palette2[9], lty = 2.5,lwd=1.5)
axis(2, at=seq(-1,1,0.5), las=1, tck=-0.08,cex.axis=1,col.axis="white",lwd=2)
box_pos <- c(1:2)
...
plot(0, type="n",main="SEACRrel Precision", xlim=c(0.5,2.5), ylim=c(-1,1), yaxt="n", xaxt="n", xlab="", ylab="",cex.axis=2)#, ylab="auTPR_comp_rank")
box(lwd = 2)
abline(h = 0, col = palette2[9], lty = 2.5,lwd=1.5)
axis(2, at=seq(-1,1,0.5), las=1, tck=-0.08,cex.axis=1,col.axis="white",lwd=2)
box_pos <- c(1:2)

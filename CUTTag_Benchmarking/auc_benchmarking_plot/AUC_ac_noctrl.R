...
# Read data
AUC_ac_noctrl <- read.table("/Users/jkx9nz/Library/CloudStorage/Dropbox/CUTTagResults/result/benchmarking/cutoff_all_sicer/ac_17me3/AUC_ac_noctrl.txt",
                            header = TRUE, sep = "\t")

# Set up PDF file
pdf("/Users/jkx9nz/Library/CloudStorage/Dropbox/CUTTagResults/result/benchmarking/cutoff_all_sicer/ac_17me3/AUC_ac_noctrl.pdf", w = 4, h = 5)
...
palette <- c(palette1[5], palette2[5], palette3[5], palette4[5], palette5[1], palette6[5], palette7[5])

# Set up the plot area
par(mar = c(5, 4, 4, 3))  # Adjust margins for better label placement
plot(0, type = "n", main = "AUCmean Rank noctrl ac", ylim = c(0.04, 1), xlim = c(0, 7), yaxt = "n", xaxt = "n", xlab = "", ylab = "",cex.axis=2)
